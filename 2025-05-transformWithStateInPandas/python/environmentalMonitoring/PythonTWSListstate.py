...
# MAGIC #### 📋 Summary 
# MAGIC
# MAGIC This Environmental Monitoring example shows how to use Apache Spark's **transformWithStateInPandas** API for arbitrary stateful stream processing in PySpark. This notebook focuses on transformWithStateInPandas's **ListState** capabilities to manage state values.
