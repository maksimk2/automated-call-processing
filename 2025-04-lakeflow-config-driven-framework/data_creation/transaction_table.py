...
processor_info_schema = ArrayType(StructType([
    ...
    StructField("processor_count", DoubleType(), nullable=True)
]))

# Define the schema for the DataFrame
schema = StructType([
    StructField("operatingsystem_id", IntegerType(), nullable=False),
...
df_binary.repartition(1).write.mode("append").parquet("/Volumes/dbx/bronze/input_data/tenant_id1/transaction_table")
